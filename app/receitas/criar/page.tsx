          ...
          <Grid item xs={12} lg={5}>
            <Paper elevation={0} sx={{ p: 3, mb: 3, border: '1px solid #e0e0e0', borderRadius: 2 }}>
              <Typography variant="h6" gutterBottom sx={{ display: 'flex', alignItems: 'center', gap: 1, color: 'warning.main', fontWeight: 700 }}>
                <ScrollText size={20} /> Parâmetros RDC 429
              </Typography>
              <Stack spacing={2.5}>
                
                <FormControl fullWidth>
                    <InputLabel>Grupo de Alimentos (RDC 429)</InputLabel>
                    <Select value={selectedGrupoAnvisa || ''} label="Grupo de Alimentos (RDC 429)" onChange={handleGrupoAnvisaChange}>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={6}>
                    <TextField label="Porção Declarada" value={porcaoFinal} disabled fullWidth InputProps={{ endAdornment: <InputAdornment position="end">g</InputAdornment> }} helperText="Calculado (RDC 429)" />
                  </Grid>
                  <Grid item xs={6}>
                    <FormControl fullWidth>
            ...
            <Paper elevation={0} sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 2, bgcolor: '#fff5f5', borderColor: '#feb2b2' }}>
              ...
              <Typography variant="caption" display="block" sx={{ mb: 2 }}>
                  Selecione os alérgenos que <strong>não fazem parte da receita</strong>, mas que são manipulados na mesma área (RDC 26).
              </Typography>
