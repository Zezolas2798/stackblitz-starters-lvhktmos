...
edges:
  ...
  - renderiza: "[[GERENCIAMENTO_ROTULAGEM_E_PRODUTO]]"
  - consumido_por: "[[producao]]"
codigo_relacionado:
...
Este documento especifica a arquitetura, regras de negócio e infraestrutura do módulo de **Fichas Técnicas (Indústria)**. Atua de forma simbiótica ao [[ingredientes]], centralizando a inteligência de precificação, cálculo nutricional regulatório ([[RDC_429_2020_IN_75_2020]]) e roteamento de sub-receitas para rotulagem.
...
🔗 Detalhes completos em [[CONFORMIDADE_ROTULAGEM_MESTRE]] e [[GERENCIAMENTO_ROTULAGEM_E_PRODUTO]].
...
| Alergênicos e Regras Gerais | [[RDC_727_2022]] | [[RDC_727_Original]] |
| Alegações Nutricionais (INC) | [[RDC_54_2012_IN_75_2020_INC]] | [[RDC_54_Original]] |
| Rotulagem Frontal (FOP) | [[GERENCIAMENTO_ROTULAGEM_E_PRODUTO]] | — |

---

## 8. Hub de Conformidade

🔗 [[CONFORMIDADE_ROTULAGEM_MESTRE]]
