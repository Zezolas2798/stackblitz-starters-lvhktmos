...
> This technical model is a formalization of the business and regulatory concepts defined in the Discovery Source: [`docs/ingredientes.md`](../../ingredientes.md).
> For the global taxonomy ID, refer to the [[registry|System Registry]].
...
> Legislação principal: Decreto 4.680/2003 (Transgenia) e RDC 727/2022 (Alergênicos).
