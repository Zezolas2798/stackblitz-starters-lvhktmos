...
edges:
  ...
  - alimenta: "[[features/industria/discovery/fichas_tecnicas_industrial]]"
  - alimenta: "[[features/uan/discovery/research/_uan]]"
  - processado_por: "supabase/functions/calcular-nutrientes/index.ts"
  - integra: "[[spec-ingredientes]]"
---
---
...
> [!NOTE] DomainSpec Discovery Source
> Este documento funciona como a **fonte fundacional de negócios e legislações** para o módulo de Ingredientes. 
> As regras descritas aqui foram fatiadas e formalizadas tecnicamente na arquitetura [DomainSpec](features/ingredientes/SPEC.md).
> Para ver as especificações de código, regras de estado e operações, acesse os arquivos na pasta `docs/features/ingredientes/`.

Este documento define o "Master Data" dos insumos. Para informações sobre **Estoque (Saldos, Lotes e Validades)**, consulte o documento especializado **[[spec-ingredientes]]**.
...
> 
> **Legislação:** [[legislacao/RDC_727_2022]] Art. 18 e 19.

### 3.6. Lógica de Transgênicos (GMO)

A conformidade com o [[legislacao/Decreto_4680_2003]] é implementada de forma **contextual por tipo de ingrediente**:
...
> 🔗 Para regras de disparo da Lupa: [[legislacao/RDC_429_2020_IN_75_2020]]
...
| Motor | Tabelas | Foco |
|-------|---------|------|
| **UAN** | `fichas_tecnicas_uan`, `composicao_fichas_uan` | Custo de refeição, per capitas, planejamento hospitalar. Detalhes em [[features/uan/discovery/research/_uan]]. |
| **Indústria** | `receitas`, `composicao_receitas` | Rotulagem GxP, Lupa ANVISA, validade. Detalhes em [[features/industria/discovery/fichas_tecnicas_industrial]]. |
...
|------|-------------------|----------------|
| Alergênicos, Lactose, Regras Gerais | [[legislacao/RDC_727_2022]] | [[legislacao/fontes/RDC_727_Original]] |
| Transgênicos (Selo T) | [[legislacao/Decreto_4680_2003]] | [[legislacao/fontes/Decreto_4680_Original]] |
| Tabela Nutricional e Lupa | [[legislacao/RDC_429_2020_IN_75_2020]] | [[legislacao/fontes/RDC_429_IN75_Original]] |
| Glúten | [[legislacao/Lei_10674_2003]] | [[legislacao/fontes/Lei_10674_Original]] |

---

## 7. Hub de Conformidade

🔗 Para a orquestração completa de todas as legislações: [[legislacao/hub-mestre]]
