...
edges:
  - implements: "[[features/uan/discovery/research/lista_compras]]"
  - queries: "[[features/uan/discovery/research/cardapios]]"
  - queries: "[[features/uan/discovery/research/_uan]]"
  - queries: "[[features/ingredientes/discovery/ingredientes]]"
  - produces: "[[registry#uan.ListaCompraUAN]]"
  - contextualizes: "[[shared/spec-architecture]]"
  - derives-from: "[[features/ingredientes/technical/queries]]"
