...
> Os blocos fundamentais para descrever o domínio do sistema. Cada conceito no [[sistema.registry]] mapeia para exatamente um desses tipos.
...
|---|---|---|
| Uma coisa com ID e histórico | Entity | [[ingredientes]], [[fichas_tecnicas_industrial]], [[producao]] |
| Uma coisa definida por seus valores, sem ID | Value Object | Dentro do doc da Entity que contém |
| Um conjunto fixo de opções | Enum / Type | [[sistema.registry]] |
| Uma fórmula que computa um valor | Calculation | [[sistema.registry]] + doc do módulo |
| Uma condição que bloqueia uma ação | Rule | [[sistema.registry]] + doc do módulo |
| Uma estratégia que escolhe comportamento | Policy | [[sistema.registry]] + doc do módulo |
| Um boundary onde dados cruzam | Interface | [[sistema.registry]] |
| Uma conversão de shape | Mapping | [[sistema.registry]] |
