...
edges:
  ...
  - depende: "[[fichas_tecnicas_industrial]]"
  - depende: "[[ingredientes]]"
...
Este documento detalha a engenharia por trás da **Página do Produto** e do **Motor de Geração de Rótulos**, integrando a lógica de software com os requisitos do [[CONFORMIDADE_ROTULAGEM_MESTRE]].
