...
tags:
  ...
  - tema/transgenicos
edges:
  - orquestra: "[[RDC_727_2022]]"
  - orquestra: "[[RDC_429_2020_IN_75_2020]]"
  - orquestra: "[[RDC_54_2012_IN_75_2020_INC]]"
  - orquestra: "[[Decreto_4680_2003]]"
  - orquestra: "[[Decreto_9013_2017_RIISPOA]]"
  - orquestra: "[[Lei_10674_2003]]"
  - orquestra: "[[Portaria_INMETRO_249_2021]]"
  - orquestra: "[[VDR_Tabelas_Populacionais]]"
  - implementado_por: "[[ingredientes]]"
  - implementado_por: "[[fichas_tecnicas_industrial]]"
  - implementado_por: "[[GERENCIAMENTO_ROTULAGEM_E_PRODUTO]]"
---
...
3. **Conteúdo Líquido:** Declaração quantitativa em métricas legais ([[Portaria_INMETRO_249_2021]]).
...
|---|---|---|
| **ANVISA** | Tabela Nutricional e Lupa (FOP) | [[RDC_429_2020_IN_75_2020]] |
| **ANVISA** | Alergênicos, Lactose e Regras Gerais | [[RDC_727_2022]] |
| **ANVISA** | Alegações Nutricionais (INC) | [[RDC_54_2012_IN_75_2020_INC]] |
| **MAPA** | Produtos de Origem Animal (RIISPOA) | [[Decreto_9013_2017_RIISPOA]] |
| **INMETRO** | Metrologia (Conteúdo Líquido) | [[Portaria_INMETRO_249_2021]] |
| **Lei Federal** | Glúten (Presença/Ausência) | [[Lei_10674_2003]] |
| **Lei Federal** | Transgênicos (Selo T) | [[Decreto_4680_2003]] |
| **Referência** | VDR por Grupo Populacional | [[VDR_Tabelas_Populacionais]] |
...
- **Implementação Tecnológica:** [[ingredientes]]
...
- **Implementação Tecnológica:** [[fichas_tecnicas_industrial]]
...
- **Implementação Tecnológica:** [[GERENCIAMENTO_ROTULAGEM_E_PRODUTO]]
- **Layout Engine:** Aplica as regras de contraste ([[RDC_727_2022]]), altura mínima de fontes ([[Portaria_INMETRO_249_2021]]) e inserção de selos (SIF/T/Arte).
...
4. **GLÚTEN:** `CONTÉM GLÚTEN` ou `NÃO CONTÉM GLÚTEN` ([[Lei_10674_2003]])
