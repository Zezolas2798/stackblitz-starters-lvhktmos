    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (upsertData.length === 0) {
                setMsg({ open: true, text: 'Nenhuma altera+º+úo para salvar.', type: 'success' });
                return;
            }
                            ...
                            <Table sx={{ minWidth: 1100 }}>
                                <TableHead sx={{ bgcolor: alpha(theme.palette.primary.main, 0.03) }}>
                                    <TableRow>
                                        ...
                                        <TableCell align="center" sx={{ fontWeight: 'bold', borderLeft: '1px solid', borderColor: 'divider' }}>Per+¡odo</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>Status</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>Hor+írio</TableCell>
                                        ...
                                        equipamentosMonitorados.map((equip) => {
                                            ...
                                            return sessions.map((periodo, idx) => {
                                                ...
                                                const rangeText = equip.temp_ideal_min !== null || equip.temp_ideal_max !== null 
                                                    ? `Meta: ${equip.temp_ideal_min ?? '-Ôê×'}-¦C a ${equip.temp_ideal_max ?? '+Ôê×'}-¦C`
                                                    : 'Sem meta';
                                                ...
                                                return (
                                                    <TableRow key={logKey} sx={idx % 2 !== 0 ? { bgcolor: alpha(theme.palette.primary.main, 0.02) } : {}}>
                                                        {idx === 0 && (
                                                            <TableCell rowSpan={freq} sx={{ fontWeight: 600, bgcolor: 'background.default', borderBottom: '1px solid', borderColor: 'divider', minWidth: 200 }}>
                                                                ...
                                                                <Typography variant="caption" color="text.secondary" display="block">
                                                                    {equip.parent?.nome} {equip.locais?.length > 0 && `ÔÇó ${equip.locais[0].nome}`}
                                                                </Typography>
                                                                <Chip 
                                                                    label={rangeText} 
                                                                    size="small" 
                                                        ...
                                                        <TableCell align="center" sx={{ borderLeft: '1px solid', borderColor: 'divider' }}>
                                                            <Chip 
                                                                label={equip.horarios_afericao?.[idx] ? equip.horarios_afericao[idx] : (periodo === 'MANHA' ? 'MANH+â' : periodo === 'TARDE' ? 'TARDE' : `${periodo}-¬ AFER.`)} 
                                                                size="small" 
            ...
            case 1:
                return (
                    <Box sx={{ mt: 8, textAlign: 'center', opacity: 0.5 }}>
                        ...
                        <Typography variant="body2">Em breve: M+¦dulo para registro e controle de amostras de alimentos.</Typography>
                    </Box>
                );
            case 2:
                return (
                    <Box sx={{ mt: 8, textAlign: 'center', opacity: 0.5 }}>
                        ...
                        <Typography variant="h6">Controle de +ôleo</Typography>
                        <Typography variant="body2">Em breve: Registro de trocas e qualidade do +¦leo de fritura.</Typography>
                    </Box>
                );
            default:
                return null;
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            QUALIDADE GxP ÔÇó Monitoramento e registros t+®cnicos
                        </Typography>
                    </Box>
                </Box>
            </Box>
