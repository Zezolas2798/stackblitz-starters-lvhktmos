    ...
    try {
        const res = await client.query(`
            SELECT el.id, el.numero_lote_fabricante,
                   el.ingrediente_id, i.nome as ingrediente_nome,
            ...
            WHERE el.status = 'APROVADO' AND el.quantidade_atual_g_ml > 0
            LIMIT 5
        `);
        console.log("LOTES JOIN WORKED WITH INGREDIENTES:", res.rows);
    } catch(e) {
